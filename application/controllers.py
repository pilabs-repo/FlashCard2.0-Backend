...
# @app.route("/hello/worker", methods=['GET', 'POST'])
# def firsttask():
#     # tmtd = (datetime.datetime.now(tz=myTimeZone)+datetime.timedelta(seconds=10))
#     # tmtd = datetime.datetime.combine(datetime.date.fromisoformat('2022-02-25'), datetime.time.fromisoformat('18:20:05'))
#     # tmtd = datetime.datetime(2022, 2, 25, 17, 25, 5, tzinfo= myTimeZone)
#     job = tasks.just_say_hello.apply_async()
#     # res = job.wait()
#     return {str(job): datetime.datetime.now(myTimeZone),'job':'hello will be told in 10s'}, 200

# @app.route("/mail", methods=['GET', 'POST'])
# def secondtask():
#     job = tasks.send_mail.apply_async(countdown = 5)
#     # res = job.wait()
#     return {str(job): datetime.datetime.now(myTimeZone), 'job':'mail sending triggered. Mail will be sent in 5s'}, 200

# @app.route("/update", methods=['GET', 'POST'])
# def update():
#     if request.method =='GET':
#         return  render_template('show-update.html', error = None)
        
# @app.route("/test_sse", methods=['GET', 'POST'])
# def test_sse():
#     if request.method =='GET':
